...
import React, { Component, Dispatch, useContext, useState } from 'react';
import {
    Card,
    Form,
    Input,
        ...
        props.form?.validateFields((err: any, values: any) => {
            Axios({
                ...
                headers: {
                    ...
                    partition: values.task_partition[0],
                    ...
                    <div className="gutter-box">
                        <Card title="任务创建" bordered={false}>
                            <Form onSubmit={handleSubmit}>
                                ...
                                <FormItem {...formItemLayout} label="队列选择">
                                    <Col span={8}>
                                        {getFieldDecorator('task_partition', {
                                            rules: [
                                                {
                                                    required: true,
                                                    message: '必须选择分区！',
                                        ...
                                        })(<Cascader options={props.partitions} />)}
                                    </Col>
                                </FormItem>
                                ...
                                <FormItem {...formItemLayout} label="任务脚本">
                                    <Col span={8}>
                                        {getFieldDecorator('script', {
                                            ...
                                            <Input
                                                prefix={
                                                    <Icon type="book" style={{ fontSize: 13 }} />
                                                }
...
function mapStateToProps(state: RootState): Pick<BasicFormProps, 'partitions'> {
    return {
        partitions: [...state.Partition.partitions].map(
            (partition: TPartition): TPartition => {
                ...
                Object.assign(newItem, {
                    ...
                    label: `${partition.name},${partition.total_nodes}节点 ${partition.total_cpus}核心`,
                });
                return newItem;
            }
        ),
...
): Pick<BasicFormProps, 'setPartitions'> {
    return {
...
const BasicForm = Form.create()(
    withRouter(connect(mapStateToProps, mapDispatchToProps)(BasicForms))
);
