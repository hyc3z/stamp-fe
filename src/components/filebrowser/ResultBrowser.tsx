...
function MyResultBrowser (){
    ...
    const updateFiles = async () => {
        const p = await Axios.get("/file/result").then(data => {return data.data})
        const curstate = {...fstate}
        ...
        return (
            <div>
                ...
                <Card title="文件管理" bordered={false}>
                    ...
                    <FileManager rootFolderName={"结果文件夹"} contextMenu={resultMenu} onContextMenuItemClick={handleClickResult} fileSystemProvider={fstate.resultList} onToolbarItemClick={handleToolbarClick}/>
