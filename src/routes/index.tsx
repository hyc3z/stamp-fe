...
import { AdminMenu, IFMenuBase, IFMenu } from './config';
...
export default function CRouter() {
    ...
    return (
        <WysiwygContext.Provider
            value={{ wstate, changeState, changeStateWithString, changeScriptPath }}
        >
            ...
            >
                <JobContext.Provider
                    value={{ jobState, changeJobScript, changeJobSpec, changeJobStatus }}
                >
                                        ...
                                        return (
                                            <Route
                                                ...
                                                render={(props) => {
                                                    const reg = /\?\S*/g;
                                                    // 匹配?及其以后字符串
                                                    const queryParams = window.location.hash.match(
                                                        reg
                                                    );
                                                    // 去除?的参数
